...
**Total Steps:** Original (`r totalSteps`); Adjusted (`r adjTotalSteps`);
Difference +`r difftotal`    
**Mean:** Original (`r meanSteps`); Adjusted (`r adjMeanSteps`);
Difference +`r diffMean`    
**Median:** Original (`r medianSteps`); Adjusted (`r adjMedianSteps`);
